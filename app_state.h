...
struct AppState
{
    ...
    HBRUSH hbrMainBack = nullptr;
    COLORREF hbrMainBackColor = CLR_INVALID;
    ...
    std::shared_ptr<TerminalBuffer> termBuffer;
    ...
    HWND hwndSymbol = nullptr;       // ★ 추가: 특수기호 창 핸들
    HWND hwndTargetEdit = nullptr;   // ★ 추가: 특수기호를 입력할 대상 창 핸
